...
final class UserApiTest extends TestCase
{
    ...
    public function show_returns_single_resource(): void
    {
        ...
        // Act: 詳細取得APIを実行
        $response = $this->getJson("/api/v1/users/{$model->id}");
    ...
    public function update_modifies_existing_resource(): void
    {
        ...
        // Act: 更新APIを実行
        $response = $this->putJson("/api/v1/users/{$model->id}", $data);
    ...
    public function destroy_deletes_resource(): void
    {
        ...
        // Act: 削除APIを実行
        $response = $this->deleteJson("/api/v1/users/{$model->id}");
