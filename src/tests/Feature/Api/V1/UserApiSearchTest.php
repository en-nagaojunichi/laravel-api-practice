...
final class UserApiSearchTest extends TestCase
{
    ...
    public function index_sorts_ascending(): void
    {
        ...
        $response = $this->getJson('/api/v1/users?sort_by=created_at&sort_order=asc');
    ...
    public function index_sorts_descending(): void
    {
        ...
        $response = $this->getJson('/api/v1/users?sort_by=created_at&sort_order=desc');
    ...
    public function index_filters_by_name(): void
    {
        ...
        // Act: nameでフィルタリング
        $response = $this->getJson('/api/v1/users?name=検索');
    ...
    public function index_filters_by_email(): void
    {
        ...
        // Act: emailでフィルタリング
        $response = $this->getJson('/api/v1/users?email=test@example.com');
    ...
    public function index_filters_by_email_verified_at(): void
    {
        ...
        $response = $this->getJson('/api/v1/users?email_verified_at=2025-01-15');
    ...
    public function index_filters_by_email_verified_at_from(): void
    {
        ...
        $response = $this->getJson('/api/v1/users?email_verified_at_from=2025-01-15');
    ...
    public function index_filters_by_email_verified_at_to(): void
    {
        ...
        $response = $this->getJson('/api/v1/users?email_verified_at_to=2025-01-15');
    ...
    public function index_filters_by_email_verified_at_range(): void
    {
        ...
        $response = $this->getJson('/api/v1/users?email_verified_at_from=2025-01-10&email_verified_at_to=2025-01-20');
