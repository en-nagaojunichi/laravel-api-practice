...
final class RoomApiTest extends TestCase
{
    ...
    public function show_returns_single_resource(): void
    {
        ...
        // Act: 詳細取得APIを実行（複合キー）
        $response = $this->getJson("/api/rooms/{$model->region}/{$model->facility_code}/{$model->room_number}");
    ...
    public function update_modifies_existing_resource(): void
    {
        ...
        // Act: 更新APIを実行（複合キー）
        $response = $this->putJson("/api/rooms/{$model->region}/{$model->facility_code}/{$model->room_number}", $data);
    ...
    public function destroy_deletes_resource(): void
    {
        ...
        // Act: 削除APIを実行（複合キー）
        $response = $this->deleteJson("/api/rooms/{$model->region}/{$model->facility_code}/{$model->room_number}");
